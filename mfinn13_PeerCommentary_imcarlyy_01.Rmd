---
title: "mfinn13_PeerCommentary_imcarlyy_01"
...
#Comment: I like how you clearly lay out what the code is meant to do at each step.
...
#Comment: I wasn't aware there was a function for this. Cool! I assume this is from the stringr package. 
...
x <- m[,c(2,3,6)]
x
#comment: I coded this differently, but your way looks more efficient!
```
...
a
#Comment: I also coded this slightly differently, but I think your way is equally as efficient. 
```
...
#Comment: I ordered my steps differently in this challenge but the code itself was pretty much the exact same for me. 
...
dataframed_m3
#Comment: I did essentially the same thing.
```
...
dataframed_m3
#Comment: I actually messed this up and you did it right. I only wrote as.logical(dataframed_m3[,2]), which doesn't changed the 2nd column, it just outputs the second column as logical data. 
```
...
#Comment: I experienced some similar challenges. Overall, though, I think you did a great job. I definitely learned some things from your code, which I talked about in my above comments. Also, you definitely did a much better job than I of commenting and making it clear what each section of code is meant to do. Great job!